var products = [
    ...
    for (var i = 0; i <products.length; i++) {
        data += `<tr><td class="Product_Table">${products[i].id}</td><td  class="Product_Table">${products[i].name}</td><td class="Product_Table">${products[i].price}</td><td class="Product_Table">${products[i].description}</td></tr>`;
}
